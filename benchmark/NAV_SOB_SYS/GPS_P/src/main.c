...
static SAMPLING_PORT_ID_TYPE  gps_proc_p_sport;
...
void* com_thread_func(void)
{
    ...
    while(1)
    {
        ...
        WRITE_SAMPLING_MESSAGE(gps_proc_p_sport,
...
int main()
{
    ...
    CREATE_SAMPLING_PORT("GPS_PROC_SEND_P_SPORT", 16, SOURCE,
                         GPS_PERIOD, &gps_proc_p_sport, &ret_type);
    if(ret_type != NO_ERROR)
    {
