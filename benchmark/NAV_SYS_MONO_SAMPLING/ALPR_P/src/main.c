...
static SAMPLING_PORT_ID_TYPE  alpr_p_sport;
...
void* com_thread_func(void)
{
    ...
    while(1)
    {
        ...
        READ_SAMPLING_MESSAGE(alpr_p_sport,
...
int main ()
{
    ...
    CREATE_SAMPLING_PORT("GPS_ALPR_RECV_P_SPORT", 16, DESTINATION,
                         GPS_PERIOD, &alpr_p_sport, &ret_type);
    if(ret_type != NO_ERROR)
    {
